...
##The localhost8080(backend spring) and localhost3000(frontend Next) standard ports are used in code for paths,Any changes in this must be changed in code as well.
